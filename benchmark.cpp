...
int main()
{
    ...
    constexpr std::size_t num_reads {2'000'000};
    constexpr unsigned read_size {150};
    constexpr ContigRegion::Size contig_size {5'000'000};
    
    std::cout << "Generating mappable data" << std::endl;
    auto mappable_data = generate_mappable_data(num_reads, read_size, contig_size);
    std::cout << "Generating interval tree data" << std::endl;
